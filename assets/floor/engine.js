  ...
  repListnner= function() {
    ...
    $('#reportTools').show(200, function() {
      ...
      for (var k in ROOM) {
        ...
        number++;
        //s= ((ROOM[k].area)/3600).toFixed(2);
        //console.log("he" ,s);
        ROOM[k].surface =((ROOM[k].area)/3600).toFixed(2);
        // console.log(s);
      }
      ...
      //callback
      //result =console.log(JSON.stringify(ROOM));
    });
